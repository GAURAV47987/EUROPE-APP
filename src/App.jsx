...
const ITINERARY = [
  ...
  { date: "Sep 3", city: "budapest", title: "Walking Tour + Parliament Day", items: [
    { time: "10:00 AM", text: "Free Walking Tour (booked)", booked: true, note: "Covers St. Stephen's Basilica, Elizabeth Square, Vörösmarty tér, Dunakorzó, Chain Bridge, Holocaust Memorial, Soviet Monument, Ronald Reagan statue, Parliament exterior and Shoes on the Danube — the entire Pest sightseeing morning in one go. Runs to ~12:30pm." },
    { time: "12:30 PM", text: "Lunch — Goulash Kitchen & Bar", booked: false, note: "2-minute walk from the tour end, right on the Danube — live music, stunning Parliament views, great goulash soup. No booking needed." },
    { time: "2:00 PM", text: "Gerbeaud Café — Vörösmarty Square", booked: false, note: "Famous since 1858 — order the Dobos Torte and a coffee, sit on the outdoor terrace. Take your time after the big morning walk." },
    { time: "3:30 PM", text: "High Note SkyBar (book ahead)", booked: false, note: "10-minute walk from Gerbeaud — rooftop directly overlooking St. Stephen's Basilica, best rooftop view in Budapest. Book a table for 3:30pm — cocktails with the Basilica dome right in front of you." },
    { time: "5:45 PM", text: "Hungarian Parliament Tour (booked)", booked: true, note: "15-minute walk from High Note SkyBar along the Danube. Crown Jewels, main staircase, Dome Hall — guided tour in English, ~45 minutes." },
    { time: "7:30 PM", text: "New York Café", booked: false, note: "One of the most opulent cafés in the world — gilded ceilings, chandeliers, literary history. Go for the atmosphere: coffee and a slice of cake, no full dinner needed." },
    { time: "9:00 PM", text: "Szimpla Kert (ruin bar)", booked: false, note: "15-minute walk into the Jewish Quarter. The original ruin bar — go after 9pm for the real atmosphere. Cheap beer, psychedelic décor, hidden rooms, open until 4am." },
  ]},
  { date: "Sep 4", city: "budapest", title: "Buda Side + Danube Cruise Night", items: [
    { time: "9:00 AM", text: "Gellért Hill", booked: false, note: "Bus 27 from Móricz Zsigmond körtér, or walk up from Liberty Bridge (~20–30 min climb). Liberty Statue, Citadella fortress, Cave Church (open 9:30am–7:30pm, 1,200 HUF entry). Budget ~1–2 hours for the climb, photos, and viewpoint terraces." },
    { time: "11:00 AM", text: "Walk down to Liberty Bridge", booked: false, note: "Cross from Buda to Pest — the most beautiful bridge in Budapest, emerald-green Art Nouveau iron. Walk to the middle, look both ways." },
    { time: "11:30 AM", text: "Great Market Hall", booked: false, note: "Right at the end of Liberty Bridge on the Pest side. Ground floor for fresh produce and paprika shopping; first floor for goulash lunch at Fakanál Bistro — best value authentic Hungarian lunch in Budapest." },
    { time: "1:30 PM", text: "Funicular to Buda Castle", booked: false, note: "Cross back to Buda. Funicular up from Clark Ádám tér (€5 return, 3-minute ride) — the view from the top is immediate and extraordinary." },
    { time: "2:00 PM", text: "Buda Castle District", booked: false, note: "Walk the Tóth Árpád Promenade along the castle walls — free, best views in Budapest. Courtyards, National Gallery exterior, Matthias Church (€10 inside)." },
    { time: "3:30 PM", text: "Fisherman's Bastion", booked: false, note: "Right next to Matthias Church — small entry fee at this time (~€5, free after 7pm). The view of Parliament across the Danube from here is the best in Budapest — best photo of the whole trip." },
    { time: "5:00 PM", text: "Return to hotel, freshen up", booked: false },
    { time: "6:30 PM", text: "Dinner — Mazel Tov (book ahead)", booked: false, note: "Jewish Quarter — beautiful greenhouse courtyard restaurant, outstanding food, great atmosphere." },
    { time: "8:30 PM", text: "Danube Dinner Cruise (booked)", booked: true, note: "Parliament, Buda Castle, Matthias Church and all the bridges lit up and gliding past as you eat dinner with live music. 2.5 hours on the Danube." },
    { time: "11:00 PM", text: "GoodSpirit Bar (hotel)", booked: false, note: "Nightcap downstairs in the hotel — perfect after a big day." },
  ]},
  { date: "Sep 5", city: "budapest", title: "Relaxed Day + SPARTY Night", items: [
    { time: "10:00 AM", text: "Slow morning coffee — Café Central or Espresso Embassy", booked: false, note: "Best specialty coffee in Budapest. Sit outside, read, take it easy — big night ahead. Sparty runs 9:30pm–2/3am, so keep today relaxed." },
    { time: "11:30 AM", text: "Jewish Quarter wander", booked: false, note: "Kazinczy utca, Dob utca and the surrounding streets — the most atmospheric neighbourhood in Budapest. Optionally visit Dohány Street Synagogue (largest in Europe, €14.50pp), or just walk and browse." },
    { time: "1:00 PM", text: "Lunch — Bors GasztroBar", booked: false, note: "Kazinczy utca 10 — creative soups and sandwiches, always packed with locals, exceptional quality. Queue moves fast." },
    { time: "2:30 PM", text: "Széchenyi Thermal Baths — daytime swim", booked: false, note: "A relaxed afternoon swim before returning tonight for Sparty — the Neo-baroque architecture is extraordinary to see properly in daylight. Book entry at szechenyibath.hu." },
    { time: "4:30 PM", text: "Back to hotel, rest", booked: false },
    { time: "6:00 PM", text: "Early dinner — Fat Mama", booked: false, note: "Live band every night, BBQ ribs, outdoor fire pit courtyard. Great energy, great food, perfect pre-Sparty dinner. Walk-in or book." },
    { time: "8:00 PM", text: "Pre-Sparty drinks — Instant-Fogas", booked: false, note: "7 dance floors, 18 bars — warm up here before heading to Széchenyi at 9:30pm." },
    { time: "9:30 PM", text: "SPARTY at Széchenyi Baths (booked)", booked: true, note: "The legendary Budapest pool party — DJs, lights, dancing in the outdoor pools of the Neo-baroque baths. Open until 3am. Bring your swimsuit, a waterproof phone case, and some cash for drinks." },
  ]},
...
function BudgetTab({ budget, addExpense, removeExpense }) {
  ...
  const exportPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text("Europe & Greek Islands — Budget Summary", 14, 18);
    doc.setFontSize(10);
    ...
    doc.setFontSize(13);
    doc.setTextColor(0);
    doc.text(`Total: $${totalAUD.toLocaleString(undefined, { maximumFractionDigits: 0 })} AUD (approx., latest conversion rates)`, 14, 34);

    autoTable(doc, {
      startY: 40,
      head: [["Currency", "Total"]],
      body: Object.entries(totals).map(([cur, amt]) => [
        cur,
    ...
    autoTable(doc, {
      ...
      head: [["Category", "Total (AUD)"]],
      body: sortedCategories.map((cat) => [
        cat,
    ...
    autoTable(doc, {
      startY: doc.lastAutoTable.finalY + 8,
      head: [["Description", "Category", "City", "Amount"]],
      body: [...budget].reverse().map((e) => [
        e.description,
        e.category,
    ...
    doc.save("europe-trip-budget.pdf");
  };
